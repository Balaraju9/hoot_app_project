...
//IOS PLATFORM
class ShortAnswerIOS extends StatefulWidget {
  const ShortAnswerIOS({super.key});

  @override
  State<ShortAnswerIOS> createState() => _ShortAnswerIOSState();
}

//ENTIRE CODE
class _ShortAnswerIOSState extends State<ShortAnswerIOS> {
